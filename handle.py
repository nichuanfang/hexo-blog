...
post_list.append('public/culture/shows/detail/index.html')
...
for post in post_list:
	...
	with open(post, 'r', encoding='utf-8') as f:
		...
		if post_name in ['archives', 'categories', 'public', 'tags', 'links', 'culture', 'books', 'documentaries',
		                 'movies', 'music', 'shows', 'variety-show', 'detail']:
			...
			if post_name == 'culture' or post_name == 'books' or post_name == 'documentaries' or post_name == 'movies' \
					or post_name == 'music' or post_name == 'shows' or post_name == 'variety-show' or (
					post_name == 'detail' and post.replace('\\', '/').split('/')[-4] == 'culture'):
				img_num = 3
